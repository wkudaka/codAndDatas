...
c esses são o que eu utilizei para testar
c	state(5)=1
c	state(9)=1
...
100   format(1X,100f16.8)
      ...
      tfp=1
		...
		enddo
	   !rule 2����S_i(t+1)=0����i������Ч��������:  ����2.1,��j�ٽ�i����S_j(t)=0;
	   !                                           ����2.2����g_ii=0��r_ii=0,��S_i(t)=0;
	   !                                           ����2.3����g_ii=1����ì��
	   !       ��S_i(t+1)=0����ֻ��һ��S_j(t)*rm(i,j).ne.0: ����2.4�����i����Ч�ٽ����÷��㣬����i���Դٽ����ã���S_j(t)=1;   
